<template>
    <div class="bg-primary overflow-x-hidden h-screen">
        ...
        <nav class="top-0 left-0 flex justify-between px-20 py-4 shadow-lg">
            <!-- logo -->
            <router-link :to="{name: 'Home'}" class="flex gap-2 items-center hover:opacity-75 transition-opacity duration-300">
                <img src="../../../public/img/logo.png" alt="logo upstrim">
            ...
            <div class="flex gap-10">
                <!-- notif -->
                <font-awesome-icon role="button" icon="fa-solid fa-bell" class="text-2xl hover:opacity-60 transition-opacity duration-300 text-secondary mt-1"/>
                <!-- notif -->
        ...
        <main class="w-full relative overflow-x-hidden flex justify-center pt-10 top-24">
            <!-- Gambar -->
            <!-- cloud left -->
        ...
        <!-- cloud right -->
            ...
            <div class="flex flex-col gap-3 items-center">
                ...
                <h3 class="font-bold font-nunito text-3xl text-center text-secondary">Input E-Mail</h3>
            </div>
            <form action="" class="mt-1">
                <input type="password" id="password" name="password" class="bg-transparent border border-secondary p-3 py-2 text-lg font-nunito mt-6 font-semibold text-secondary rounded outline-secondary w-full" placeholder="New E-Mail">
                <router-link :to="{name: 'Dashboard'}" type="submit" class="w-full rounded py-1.5 hover:opacity-75 transition-opacity duration-300 bg-secondary text-lg font-nunito mt-8 font-semibold">Send Link</router-link>
            </form>
